...
RSpec.describe "Poker", type: :request do
  describe "API" do
    ...
    shared_examples "レスポンスが返ってくるか" do
      it "レスポンスが返ってきているか" do
    ...
    describe "エラー(単独)が出力されるか" do
      ...
      describe "複数のエラーの時" do
        before do
          post path, params.merge(cards: ["", "S2 S4 S6 S14 S1", "aaa"])
        end
        it_behaves_like "レスポンスが返ってくるか"
    ...
    describe "リザルト(単独)が出力されるか" do
      ...
      describe "一つのリザルトで一つのtrueの時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3"])
        end
        it_behaves_like "レスポンスが返ってくるか"
      ...
      describe "複数のリザルトでtrue一つの時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3", "H9 C9 S9 H1 C1", "H13 D13 C2 D2 H1"])
        end
        it_behaves_like "レスポンスが返ってくるか"
      ...
      describe "複数のリザルトでtrue複数の時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3", "H1 H13 H12 H11 H10", "H13 D13 C2 D2 H1"])
        end
        it_behaves_like "レスポンスが返ってくるか"
    ...
    describe "エラーとリザルトが混在するとき出力されるか" do
      ...
      describe "複数のエラーと一つのリザルトが混在する" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3", "S2 S4 S6 S14 S1", "aaa"])
        end
        it_behaves_like "レスポンスが返ってくるか"
      ...
      describe "複数のエラーと複数のリザルトが混在する時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3","S13 S12 S11 S9 S6", "S2 S4 S6 S14 S1", "aaa"])
        end
        it_behaves_like "レスポンスが返ってくるか"
      ...
      describe "複数のエラーと複数のリザルトが混在する時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3","H1 H13 H12 H11 H10", "S2 S4 S6 S14 S1", "aaa"])
        end
        it_behaves_like "レスポンスが返ってくるか"
      ...
      describe "一つのエラーと複数のリザルトが混在する時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3","H1 H13 H12 H11 H10", "S2 S4 S6 S14 S1"])
        end
        it_behaves_like "レスポンスが返ってくるか"
      ...
      describe "一つのエラーと複数のリザルトが混在する時" do
        before do
          post path, params.merge(cards: ["C7 C6 C5 C4 C3","S13 S12 S11 S9 S6", "S2 S4 S6 S14 S1"])
        end
        it_behaves_like "レスポンスが返ってくるか"
